...
// each finds the signed-in user, who owns the records it reads or changes,
...
// Permissions the records routes require. Every signed-in user holds them
...
// ownerID returns the signed-in user, who owns the records an operation
