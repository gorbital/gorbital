...
type createRecordInput struct {
	...
	Body       struct {
		Title string `json:"title" minLength:"1" maxLength:"100" doc:"Unique in the merchant, ignoring case"`
...
func (h handlers) createRecord(ctx context.Context, in *createRecordInput) (*recordOutput, error) {
	record, err := h.svc.CreateRecord(ctx, in.MerchantID, domain.RecordFields{
		Title: in.Body.Title,
		Note:  in.Body.Note,
