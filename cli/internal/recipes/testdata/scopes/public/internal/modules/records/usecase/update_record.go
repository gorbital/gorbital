...
// UpdateRecord changes one record. It returns ErrRecordVersionConflict when
// in.Version is no longer current. An update that changes nothing returns
// the record as it is. The route requires PermWrite.
