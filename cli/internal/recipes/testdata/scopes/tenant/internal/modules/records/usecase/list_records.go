...
// ListRecordsInput selects a page of an organisation's records.
...
// ListRecords returns a page of the organisation orgID's records, sorted by
// one field (newest first by default).
func (s *Service) ListRecords(ctx context.Context, orgID string, in ListRecordsInput) (page.Result[domain.Record], error) {
