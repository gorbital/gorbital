...
func RegisterJobs(r *gorbital.Router, svc *opsusecase.Service) {
	...
	operation.Register(r, reg(definitions, huma.Operation{
	...
	operation.Register(r, reg(runs, huma.Operation{
	...
	operation.Register(r, reg(queues, huma.Operation{
