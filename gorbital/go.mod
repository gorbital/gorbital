...
require (
	...
	gorbital.dev/modules/idempotency v0.3.3
	gorbital.dev/modules/mail/resend v0.3.3
	gorbital.dev/modules/mail/smtp v0.3.3
	gorbital.dev/modules/mail/suppressionpg v0.3.3
	gorbital.dev/modules/observability v0.3.3
	gorbital.dev/modules/ratelimitpg v0.3.3
	gorbital.dev/modules/releases v0.3.3
