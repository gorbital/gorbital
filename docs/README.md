...
| [Ops API reference](guides/ops-api.md) | `/ops/settings`, `/ops/jobs/*`, `/ops/queues`: authentication, endpoints, error codes, audit actions |
...
| [examples/full-single](../examples/full-single) | Full preset (in progress): PostgreSQL, runtime settings, jobs and the ops APIs |
