...
|---|---|---|---|
| `APP_ENV` | `development` | No | **Chosen by you**: `production` on servers (the Docker image sets it) |
...
| `APP_DOCS_ENABLED` | `true` | No | **Chosen by you** |
| `APP_CORS_ORIGINS` | Empty | No | **Chosen by you**: your web frontends |
