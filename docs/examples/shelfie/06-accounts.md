...
<!-- include examples/apps/shelfie/cmd/api/signin.go#sign-in-options -->
...
<!-- include examples/apps/shelfie/db/migrations/20260920000003_profiles.sql -->
...
<!-- include examples/apps/shelfie/internal/modules/profiles/hooks.go#registration-fields -->
...
<!-- include examples/apps/shelfie/internal/modules/profiles/usecase/save_registration.go#save-registration -->
...
<!-- include examples/apps/shelfie/internal/modules/profiles/usecase/update_profile.go#update-profile -->
...
<!-- include examples/apps/shelfie/internal/modules/profiles/hooks.go#before-login -->
...
<!-- include examples/apps/shelfie/cmd/api/accounts_test.go#complete-profile -->

and a suspended reader can't sign in, while a wrong password answers as usual:

<!-- include examples/apps/shelfie/cmd/api/accounts_test.go#suspended -->
