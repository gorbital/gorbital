...
<!-- include examples/shelfie/internal/modules/books/delivery/require_client_version.go#require-client-version -->
...
<!-- include examples/shelfie/internal/modules/books/delivery/routes.go#books-group -->

<!-- include examples/shelfie/internal/modules/books/client_version_test.go#client-version-refusals -->
...
<!-- include examples/shelfie/internal/modules/books/delivery/require_client_version.go#client-version -->

The context reaches Huma handlers unchanged, so a handler reads it back with one call:

<!-- include examples/shelfie/internal/modules/books/delivery/export_books.go#export-books -->

<!-- include examples/shelfie/internal/modules/books/client_version_test.go#client-version-in-context -->
...
<!-- include examples/shelfie/internal/modules/books/delivery/require_client_version.go#capture -->
...
<!-- include examples/shelfie/internal/modules/books/delivery/require_client_version_test.go#capture-test -->
...
<!-- include examples/shelfie/db/migrations/20260920000007_subscriptions.sql#subscriptions-table -->
...
<!-- include examples/shelfie/internal/modules/books/usecase/subscriptions.go#subscriptions -->

The guard itself is the check, its name, and the error it refuses with:

<!-- include examples/shelfie/internal/modules/books/delivery/active_subscription.go#active-subscription -->

`module.go` maps that error like any other error of the module, which is what turns it into a status and a stable code:

<!-- include examples/shelfie/internal/modules/books/module.go#subscription-error -->
...
<!-- include examples/shelfie/internal/modules/books/delivery/routes.go#export-route -->

<!-- include examples/shelfie/internal/modules/books/subscription_test.go#subscription-guard -->
