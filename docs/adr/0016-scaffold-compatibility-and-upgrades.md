...
**Status:** Accepted (2026-09-14) · **Supersedes (with ADR-0015):** ADR-0012 · **Amended by:** ADR-0050 (the merge base is rebuilt from the recorded release and inputs and checked against file hashes, not replayed operations), ADR-0054 (the promise is checked by building apps generated by the latest v1 release against the current library; `orb upgrade --major` waits for the first v2 bridge release)
