...
| # | Rule | Prevents |
|---|---|---|
| 1 | Domain structs have no `json` or `db` tags; delivery maps to its request/response types, repository maps to sqlc types | API contract changing when domain or schema changes |
