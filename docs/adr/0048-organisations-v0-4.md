...
**Status:** Accepted (2026-09-15) · **Amends:** ADR-0023, ADR-0038 · **Amended by:** ADR-0050 (`orb add orgs` merges `base-full` into `base-full-multi` and converts data with new migrations), ADR-0056 (organisations' own runtime settings, purged with the organisation)
