...
| **Not included** | Social login, 2FA, passkeys, multi-tenant, ops APIs other than `/ops/settings`, `/ops/jobs/*`, `/ops/queues` and `/ops/audit` (audit stats and retention stay in v0.5) |
