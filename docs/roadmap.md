...
| [v1.1](#v11-operations-and-integrations) | Operations and integrations | 🔨 In progress | Per-organisation settings, idempotency keys, Resend bounce and complaint webhooks, Prometheus `/metrics` |
