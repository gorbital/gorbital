...
// listeners, the job client, the release tracker and the request collector.
// Run starts them; tests start them directly.
func (a *App) Workers() []lifecycle.Runner {
	return []lifecycle.Runner{a.settings, a.jobs, a.jobsManager, a.releases, a.collector}
}
