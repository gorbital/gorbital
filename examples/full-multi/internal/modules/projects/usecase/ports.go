...
type Store interface {
	...
	// SelectProject returns one of orgID's projects, or
	// ErrProjectNotFound. lock locks the row until the transaction ends.
	SelectProject(ctx context.Context, orgID orgslib.ID, id string, lock bool) (projectsdomain.Project, error)
	...
	// ErrProjectNotFound.
	DeleteProject(ctx context.Context, orgID orgslib.ID, id string) error
