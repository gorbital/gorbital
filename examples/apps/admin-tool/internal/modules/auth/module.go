...
import (
	...
	"example.com/admin-tool/internal/modules/auth/delivery"
	"example.com/admin-tool/internal/modules/auth/delivery/jobs/authcleanup"
	"example.com/admin-tool/internal/modules/auth/delivery/jobs/authrevoke"
	authdomain "example.com/admin-tool/internal/modules/auth/domain"
	"example.com/admin-tool/internal/modules/auth/repository/migrations"
