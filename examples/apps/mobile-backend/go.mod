...
require (
	...
	gorbital.dev/modules/jwt v0.2.1
...
require (
	...
	gorbital.dev/modules/auditpg v0.2.1 // indirect
	gorbital.dev/modules/auth v0.2.1 // indirect
	gorbital.dev/modules/devconsole v0.2.1 // indirect
	gorbital.dev/modules/flags v0.2.1 // indirect
	gorbital.dev/modules/idempotency v0.2.1 // indirect
	gorbital.dev/modules/jobs v0.2.1 // indirect
	...
	gorbital.dev/modules/openapi v0.2.1 // indirect
	gorbital.dev/modules/orgs v0.2.1 // indirect
	gorbital.dev/modules/ratelimitpg v0.2.1 // indirect
	gorbital.dev/modules/releases v0.2.1 // indirect
	gorbital.dev/modules/settings v0.2.1 // indirect
	gorbital.dev/modules/storage v0.2.1 // indirect
...
replace (
	...
	gorbital.dev/modules/jwt => ../../../modules/jwt
