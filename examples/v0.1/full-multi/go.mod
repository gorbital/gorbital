...
require (
	...
	gorbital.dev/modules/devconsole v0.3.4
	gorbital.dev/modules/flags v0.3.4
	gorbital.dev/modules/idempotency v0.3.4
	gorbital.dev/modules/jobs v0.3.4
	gorbital.dev/modules/mail/resend v0.3.4
	gorbital.dev/modules/mail/smtp v0.3.4
	gorbital.dev/modules/mail/suppressionpg v0.3.4
	gorbital.dev/modules/observability v0.3.4
	...
	gorbital.dev/modules/telemetry v0.3.4
)
...
require (
	...
	gorbital.dev/modules/releases v0.3.4
)
