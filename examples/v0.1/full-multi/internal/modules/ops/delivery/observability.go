...
// (ADR-0064).
func RegisterObservability(api huma.API, svc *opsusecase.Service) {
...
func (h *observabilityHandler) stream(ctx context.Context, in *windowInput) (*huma.StreamResponse, error) {
	...
	return &huma.StreamResponse{Body: func(hctx huma.Context) {
		...
		// token the request authenticated with.
		end := stream.Run(authlib.TokenFrom(r, authlib.DefaultCookieName), func(o opsusecase.Overview) error {
